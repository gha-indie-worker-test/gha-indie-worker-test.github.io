// OWLS intent-preparation tier.
//
// PROVENANCE: near-verbatim copy of
//   gha-indie-worker/gha-indie-worker.github.io : src/lib/intent.mjs
// with no intended differences. In the production site this tier is OFF by
// default; in THIS harness it is deliberately ON, because proving the mechanism
// is the harness's whole job. Nothing checks this copy for drift automatically.
//
